const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-DxT1QZqn.js","assets/useScrollAnimation-vpRpZMww.js","assets/arrow-right-ZEBglC_h.js","assets/zap-DPghQ_Hc.js","assets/target-CGsD1pPp.js","assets/dollar-sign-DBYym4rQ.js","assets/About-Dd6B2WFN.js","assets/users-b4NjELQ7.js","assets/Services-DBmB4gxA.js","assets/Blog-BJSHdYE5.js","assets/blogData-BA0daQsB.js","assets/clock-3Dt6KLfP.js","assets/BlogPost-BMLerjPH.js","assets/Contact-DScfoJM6.js"])))=>i.map(i=>d[i]);
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-foreground text-primary-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 py-14", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 mb-4 group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl gradient-primary flex items-center justify-center shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            TrendingUp,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-xl text-primary-foreground", children: "SearchLift" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/60 text-sm leading-relaxed mb-5", children: "Chennai-based SEO & digital marketing agency helping businesses grow online with result-driven, transparent, and affordable strategies." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: socialLinks.map(({ icon: Icon2, label, href }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-4 h-4 text-primary-foreground/80" })
          },
          label
        )) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-primary-foreground/90 mb-4 text-sm uppercase tracking-wider", children: "Quick Links" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: quickLinks.map(({ label, href }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: href,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-primary-foreground/90 mb-4 text-sm uppercase tracking-wider", children: "Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: serviceLinks.map(({ label, href }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: href,
            className: "text-primary-foreground/60 hover:text-primary-foreground text-sm transition-colors duration-200 hover:translate-x-1 inline-block",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-primary-foreground/90 mb-4 text-sm uppercase tracking-wider", children: "Contact Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3 text-sm text-primary-foreground/60", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Chennai, Tamil Nadu, India" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 shrink-0 text-accent" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4 shrink-0 text-accent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "contact@searchlift.in" })
              ]
            }
          ) })
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-primary-foreground/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-primary-foreground/50 text-sm", children: [
        "© ",
        year,
        " SearchLift Technologies. All rights reserved."
      ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: cn(
        ...
        scrolled ? "bg-card/95 backdrop-blur-md shadow-md border-b border-border" : "bg-card/80 backdrop-blur-sm border-b border-border/50"
      ),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "container mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg gradient-primary flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow duration-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  TrendingUp,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-lg leading-tight hidden sm:block", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "SearchLift" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/70 text-sm font-medium ml-1", children: "Technologies" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg sm:hidden text-gradient", children: "SearchLift" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center gap-1", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: link.href,
              ...
              className: cn(
                ...
                isActive(link.href) ? "text-primary" : "text-foreground/70 hover:text-foreground hover:bg-muted/60"
              ),
              children: [
                link.label,
                isActive(link.href) && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 w-4 h-0.5 gradient-primary rounded-full" })
              ]
            },
            link.href
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", children: "Get Free Audit" })
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: cn(
              ...
              isOpen ? "max-h-screen opacity-100 bg-card/98 backdrop-blur-md" : "max-h-0 opacity-0"
            ),
              ...
              navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  ...
                  className: cn(
                    ...
                    isActive(link.href) ? "text-primary bg-primary/10" : "text-foreground/70 hover:text-foreground hover:bg-muted/60"
                  ),
                  children: link.label
                },
                link.href
...
const Home = reactExports.lazy(() => __vitePreload(() => import("./Home-DxT1QZqn.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0));
const About = reactExports.lazy(() => __vitePreload(() => import("./About-Dd6B2WFN.js"), true ? __vite__mapDeps([6,1,4,5,7,2]) : void 0));
const Services = reactExports.lazy(() => __vitePreload(() => import("./Services-DBmB4gxA.js"), true ? __vite__mapDeps([8,1,3,2,4,7]) : void 0));
const Blog = reactExports.lazy(() => __vitePreload(() => import("./Blog-BJSHdYE5.js"), true ? __vite__mapDeps([9,10,1,2,11]) : void 0));
const BlogPost = reactExports.lazy(() => __vitePreload(() => import("./BlogPost-BMLerjPH.js"), true ? __vite__mapDeps([12,10,1,11,2]) : void 0));
const Contact = reactExports.lazy(() => __vitePreload(() => import("./Contact-DScfoJM6.js"), true ? __vite__mapDeps([13,1,11]) : void 0));
function PageLoader() {
